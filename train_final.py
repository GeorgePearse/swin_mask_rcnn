"""Final training script for SWIN MaskRCNN on CMR dataset."""
import torch
...
config = {
    ...
    'num_classes': 69,  # CMR dataset has 69 classes (0-68)
    'batch_size': 2,
    'num_workers': 0,  # Set to 0 to avoid multiprocessing issues with transforms
    'num_epochs': 50,
    'lr': 1e-4,
    'weight_decay': 1e-4,
